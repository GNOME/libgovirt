...
static void rest_call_async_set_error(RestProxyCall *call, GSimpleAsyncResult *result, GError *error)
{
    ...
    g_simple_async_result_set_from_error(result, local_error ? local_error : error);
